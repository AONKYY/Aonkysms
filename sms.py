...
def p1112(phone):
    ...
    if d == 200:
        print("[+] 1112 | ยิงแล้วไอสัส")
    else : 
        print("[+] 1112 | ล้มเหลวว่ะ")
...
def findclone(phone):
    ...
    if d.get("Error",False) == "Wait for timeout":
        print("[+] findclone | ยิงแล้วไอสัส")
    else :
        print("[+] findclone | ล้มเหลวว่ะ")
...
def unacademy(phone):
    ...
    if d.get("error_code",False):
        print("[+] unacademy | ล้มเหลวว่ะ")
    else :
        print("[+] unacademy | ยิงแล้วไอสัส")
...
def instagram(phone):
    ...
    if d["status"] == "ok":
        print("[+] instagram | ยิงแล้วไอสัส")
    else:
        print("[+] instagram | ล้มเหลวว่ะ")
...
def instagramv2(phone):
    ...
    if d["status"] == "ok":
        print("[+] instagram v2 | ยิงแล้วไอสัส")
    else:
        print("[+] instagram v2 | ล้มเหลวว่ะ")
...
def yandex(phone):
    ...
    if d == "{}":
        print("[+] yandex | ยิงแล้วไอสัส")
    else:
        print("[+] yandex | ล้มเหลวว่ะ")
...
def homepro(phone):
    ...
    if d["msgtype"] == "success":
        print("[+] homepro | ยิงแล้วไอสัส")
    else:
        print("[+] homepro | ล้มเหลวว่ะ")
